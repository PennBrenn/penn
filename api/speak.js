...
export default async function handler(req) {
    ...
    try {
        ...
        const badWords = ["fuck", "shit", "bitch", "cunt", "nigger", "asshole", "dick", "pussy", "whore", "slut", "bastard", "faggot", "neggurt", "negurt", "flagot", "retigga", "swast", "jew", "nig", "neck", "67", "six", "nig", "igga", "Chink", "fuggot", "fugot", "nigget", "niggette", "semem", "semen", "cum", "cumm", "cumma", "swastika", "hitler", "nazi", "rape", "touch", "grape", "raping", "rap", "cracked", "cracker"];
